...
module.exports = yeoman.generators.Base.extend({
  ...
  writeIndex: function () {
    ...
    this.initJs = this.engine(
      this.readFileAsString(join(this.sourceRoot(), 'base.js')),
      this
    );
    ...
    this.indexFile = this.appendFiles({
      html: this.indexFile,
      fileType: 'js',
      optimizedPath: 'scripts/base.js',
      sourceFileList: ['scripts/base.js'],
      searchPath: ['app', 'tmp']
    });
  },
  ...
  app: function () {
    ...
    if (this.coffee) {
      ...
      this.write('app/scripts/base.js', this.initJs);
    }
  },
